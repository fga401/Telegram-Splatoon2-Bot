...
func main() {
	...
	router.AddCommandHandler("help", service.Help, "Help Command")
	router.AddCommandHandler("help_stages", service.HelpStages, "Help Stages Command")
	router.AddCallbackQueryHandler(service.ReturnToSettingsKeyboardPrefix, service.ReturnToSettings, "Return to Settings Callback")
	router.AddCallbackQueryHandler(service.AccountSettingsKeyboardPrefix, service.AccountSetting, "Settings Callback")
	router.AddCallbackQueryHandler(service.AccountSettingsAddKeyboardPrefix, service.AddAccount, "Settings Callback")
	router.AddCallbackQueryHandler(service.AccountSettingsDeleteKeyboardPrefix, service.DeleteAccount, "Settings Callback")
