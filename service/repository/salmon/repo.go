...
import (
	...
	"telegram-splatoon2-bot/service/image/downloader"
...
func NewRepository(nintendoSvc nintendo.Service, userSvc user.Service, imageSvc imageSvc.Service, config Config) Repository {
	...
	ret := &repoImpl{
		...
		dumper:            dumper,
		grizzcoWeaponPath: config.GrizzcoWeaponPath,
		randomWeaponPath:  config.RandomWeaponPath,
...
func (repo *repoImpl) populateSchedules(schedules *nintendo.SalmonSchedules) {
