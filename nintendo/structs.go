...
/* Battle Results Begin */
var BattleType = struct {
...
func (r RegularBattleResult) GetType() BattleResultType {
	return BattleType.Regular
}
func (r GachiBattleResult) GetType() BattleResultType {
	return BattleType.Gachi
}
func (r LeagueBattleResult) GetType() BattleResultType {
	return BattleType.League
}
